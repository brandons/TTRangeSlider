...
@property (nonatomic, strong) IBInspectable UIColor *inactiveTrackTintColor;
@property (nonatomic, assign) IBInspectable float lineHeight;
@property (nonatomic, assign) IBInspectable float handleDiameter;
@property (nonatomic, assign) IBInspectable float lineCornerRadius;

@property (nonatomic, assign) IBInspectable float handleShadowRadius;
@property (nonatomic, assign) IBInspectable UIColor *handleShadowColor;
